...
Train and compare ML classifiers (SVM, DT, KNN)

Evaluate results using accuracy, confusion matrices, and classification reports
...
Decision Tree & KNN performed slightly lower (~84% accuracy)

Feature scaling and encoding significantly improved model results
